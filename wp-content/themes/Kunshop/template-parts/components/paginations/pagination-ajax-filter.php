...
<div class="custom-pagination">
    ...
    <?php if ($current_page > 1): ?>
        <a onclick="loadproductFilterMain(<?php echo $current_page - 1 ?>)" class="prev-icon bgrsize100 shinehover"></a>
    <?php else: ?>
    ...
    <?php if ($current_page < $total_pages): ?>
        <a onclick="loadproductFilterMain(<?php echo $current_page + 1; ?>)" class="next-icon bgrsize100 shinehover"></a>
    <?php else: ?>
