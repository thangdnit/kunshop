<div class="custom-pagination">
    ...
    <?php if ($current_page > 1): ?>
        <a href="<?php echo get_pagenum_link($current_page - 1); ?>" class="prev-icon bgrsize100 shinehover"></a>
    <?php else: ?>
    ...
    <?php for ($i = $start; $i <= $end; $i++) : ?>
        ...
        <?php else: ?>
            <a class="page-number shinehover" href="<?php echo get_pagenum_link($i); ?>"><?php echo $i; ?></a>
        <?php endif; ?>
    <?php endfor; ?>

    <!-- Nút "Next" -->
    <?php if ($current_page < $total_pages): ?>
        <a href="<?php echo get_pagenum_link($current_page + 1); ?>" class="next-icon bgrsize100 shinehover"></a>
    <?php else: ?>
