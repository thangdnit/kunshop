    ...
    <div class="form-contact_content form-general_content">
        <div>
            <div>
                ...
                <input id="form-contact__product-model" class="custom-input" type="text" placeholder="Ford" autocomplete="off">
            </div>
            <div>
                <div class="label-input">Phiên bản</div>
                <input id="form-contact__product-version" class="custom-input" type="text" placeholder="Đặc biệt" autocomplete="off">
            </div>
        </div>
        <div>
            <div>
                <div class="label-input">Số KM đã đi</div>
                <input id="form-contact__product-odo" class="custom-input" type="text" placeholder="10000" autocomplete="off">
            </div>
            <div>
                <div class="label-input">Năm sản xuất</div>
                <input id="form-contact__product-year" class="custom-input" type="text" placeholder="2025" autocomplete="off">
            </div>
        </div>
        <div>
            <div>
